...
if __name__ == "__main__": # RMa 환경 특화 전이학습 실행
    ...
    # RMa 환경 전용 설정 파일 사용
    conf_file = 'config_transfer_v4_RMa.yaml' # RMa 환경 특화 설정 파일 사용
    
    print("=" * 60)
    print("RMa (Rural Macro) LoRA Transfer Learning Start")
    print("=" * 60)
    ...
    print("RMa transfer learning starting...")
    engine.train() # RMa 데이터로 LoRA 전이학습 수행
    
    print("=" * 60)
    print("RMa LoRA transfer learning completed!")
